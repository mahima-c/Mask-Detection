...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            w=frame.shape[0]//2
            h=frame.shape[1]
            # cv2.line(frame, pt1=(w,0), pt2=(w,h), color=(255, 0, 0), thickness=1, lineType=8, shift=0)
            # cv2.line(frame, pt1=(200,50), pt2=(200,500), color=(255, 0, 0), thickness=1, lineType=8, shift=0)
            # cv2.line(frame, pt1=(300,50), pt2=(300,500), color=(255, 0, 0), thickness=1, lineType=8, shift=0)
            # cv2.line(frame, pt1=(400,50), pt2=(400,500), color=(255, 0, 0), thickness=1, lineType=8, shift=0)
            # cv2.line(frame, pt1=(500,50), pt2=(500,500), color=(255, 0, 0), thickness=1, lineType=8, shift=0)
            ...
            # Line_Position3=orien_lines.drawsafelines(frame,Orientation,Line_Perc2,Line_Perc2)             
          
            # Draw bounding boxeses and text
            a,b=detector_utils.draw_box_on_image(
                num_hands_detect, score_thresh, scores, boxes, classes, im_width, im_height, frame,Orientation)
            lst1.append(a)
            lst2.append(b)
